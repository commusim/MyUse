...
parser.add_argument('--input_path', default="/home/ubuntu/commusim/dataset/GaitDatasetB-silh/CASIA_B", type=str,
                    help='Root path of raw dataset.')
parser.add_argument('--output_path', default="/home/ubuntu/commusim/dataset/GaitDatasetB-silh/s128x88", type=str,
