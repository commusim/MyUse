...
from model.network.modules.local_SA import LocalBlock3D, Backbone, LocalizationST, GaussianSampleST, C3DBlock
from model.network.utils import HP, MCM, SeparateFc


class GaitSA_piror(nn.Module):
    def __init__(self):
        super(GaitSA_piror, self).__init__()
    ...
    def forward(self, silho, batch_frame=None):
        ...
        return gl, part_classification.permute(1,0,2).contiguous()
